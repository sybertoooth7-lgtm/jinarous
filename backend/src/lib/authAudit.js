...
// Drop this into backend/src/lib/ and import it from tools.js instead of spawning python3.
...
/**
 * Runs a security audit against a target URL.
 * Returns a JSON-shaped object identical to auth_audit.py output.
 */
